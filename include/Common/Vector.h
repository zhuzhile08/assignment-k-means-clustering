...
public:
	...
	constexpr iterator erase(const_iterator pos) {
		ASSERT(pos < end(), "lstd::Vector::erase: past-end iterator passed to erase!");
	...
	NODISCARD constexpr const_reference at(size_type index) const {
		...
		if (ptr >= m_end) throw std::out_of_range("lstd::Vector::at(): Index exceded current internal array bounds!");
		return *ptr;
	}
	...
	NODISCARD constexpr const_reference operator[](size_type index) const noexcept {
		auto ptr = m_begin + index;
		ASSERT(ptr < m_end, "lstd::Vector::operator[]: Index of: {} exceded array size of: {}!", index, size());
		return *ptr;
	}
