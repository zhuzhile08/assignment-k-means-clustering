...
public:
	...
	template <class Iterator> NODISCARD static constexpr json_type parse(Iterator begin, Iterator end) {
		...
		if (*begin == '{') {
			...
			ASSERT(false, "lstd::Json::parse(): invalid file!");
		}
...
private:
	...
	template <class Iterator> static constexpr string_type parseString(Iterator& begin, Iterator& end) {
		ASSERT(*begin == '\"', "lstd::Json::parseString(): JSON Syntax Error: unexcpected token!");
		...
		ASSERT(false, "lstd::Json::parseString(): JSON Syntax Error: missing token!");
		return r;
	}
	template <class Iterator> static constexpr value_type parsePrimitive(Iterator& begin, Iterator& end) {
		switch(*begin) {
			default:
				ASSERT(false, "lstd::Json::parsePrimitive(): JSON Syntax Error: unexpected token!");
				break;
		...
		ASSERT(false, "lstd::Json::parsePrimitive(): JSON Syntax Error: missing token!");
	...
	template <class Iterator> static constexpr pointer parseObject(Iterator& begin, Iterator& end, json_type& json) {
		...
		ASSERT(false, "lstd::Json::parseObject(): JSON Syntax Error: missing token!");
	...
	template <class Iterator> static constexpr array_type parseArray(Iterator& begin, Iterator& end) {
		...
		ASSERT(false, "lstd::Json::parseArray(): JSON Syntax Error: missing token!");
