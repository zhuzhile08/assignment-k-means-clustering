...
#endif
template <class Msg> inline constexpr void lstdAssert(bool, Msg);
template <class Msg> inline constexpr void vulkanAssert(int, Msg);
template <class Format, typename ... Args> inline constexpr void lstdAssert(bool, Format&&, Args&&...);
...
#ifndef NDEBUG
#define ASSERT(...) lstd::lstdAssert(__VA_ARGS__)
#define VULKAN_ASSERT(...) lstd::vulkanAssert(__VA_ARGS__)
#else
